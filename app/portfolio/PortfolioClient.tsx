...
const staticProjects = {
  ar: [
    { id: 1, slug: "al-nokhba-digital-marketing", title: "╪¡┘à┘ä╪⌐ ╪º┘ä┘å╪«╪¿╪⌐ ┘ä┘ä╪¬╪│┘ê┘è┘é ╪º┘ä╪▒┘é┘à┘è", category: "digital-ads", results: "╪▓┘è╪º╪»╪⌐ ╪º┘ä┘à╪¿┘è╪╣╪º╪¬ +┘ó┘ñ┘á┘¬╪î ╪╣╪º╪ª╪» ╪º┘ä╪º╪│╪¬╪½┘à╪º╪▒ ┘Ñ.┘ó ╪╢╪╣┘ü", client: "┘à╪¼┘à┘ê╪╣╪⌐ ╪º┘ä┘å╪«╪¿╪⌐", img: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?q=80&w=600&auto=format&fit=crop", duration: "3 ╪ú╪┤┘ç╪▒", budget: "50,000 ╪▒.╪│" },
    { id: 2, slug: "rikaz-real-estate-identity", title: "╪º┘ä┘ç┘ê┘è╪⌐ ╪º┘ä╪¿╪╡╪▒┘è╪⌐ ┘ä╪┤╪▒┘â╪⌐ ╪▒┘â╪º╪▓ ╪º┘ä╪╣┘é╪º╪▒┘è╪⌐", category: "branding", results: "╪¬╪╡┘à┘è┘à ╪┤╪╣╪º╪▒ ┘ü╪▒┘è╪» ┘ê╪»┘ä┘è┘ä ┘ç┘ê┘è╪⌐ ╪¿╪╡╪▒┘è╪⌐ ┘â╪º┘à┘ä╪⌐", client: "╪▒┘â╪º╪▓ ┘ä┘ä╪¬╪╖┘ê┘è╪▒", img: "https://images.unsplash.com/photo-1626785774573-4b799315345d?q=80&w=600&auto=format&fit=crop", duration: "╪┤┘ç╪▒ ┘ê╪º╪¡╪»", budget: "25,000 ╪▒.╪│" },
    { id: 3, slug: "masar-app-launch-video", title: "┘ü┘è╪»┘è┘ê ╪Ñ╪╖┘ä╪º┘é ╪¬╪╖╪¿┘è┘é ┘à╪│╪º╪▒ ╪º┘ä╪¬╪╣┘ä┘è┘à┘è", category: "video", results: "┘ú.┘Ñ ┘à┘ä┘è┘ê┘å ┘à╪┤╪º┘ç╪»╪⌐╪î ╪▓┘è╪º╪»╪⌐ ╪º┘ä╪¬╪¡┘à┘è┘ä╪º╪¬ +┘í┘¿┘á┘¬", client: "╪┤╪▒┘â╪⌐ ┘à╪│╪º╪▒", img: "https://images.unsplash.com/photo-1542751371-adc38448a05e?q=80&w=600&auto=format&fit=crop", duration: "╪┤┘ç╪▒╪º┘å", budget: "35,000 ╪▒.╪│" },
    { id: 4, slug: "gourmet-social-growth", title: "╪Ñ╪»╪º╪▒╪⌐ ╪º┘ä╪│┘ê╪┤┘è╪º┘ä ┘à┘è╪»┘è╪º ┘ä┘à╪╖╪º╪╣┘à ╪¼┘ê╪▒┘à┘è┘ç", category: "social", results: "+┘ñ┘Ñ ╪ú┘ä┘ü ┘à╪¬╪º╪¿╪╣ ╪¼╪»┘è╪»╪î ╪¬┘ü╪º╪╣┘ä ╪┤┘ç╪▒┘è +┘í┘ú┘á┘¬", client: "╪¼┘ê╪▒┘à┘è┘ç ╪º┘ä╪╣╪º┘ä┘à┘è╪⌐", img: "https://images.unsplash.com/photo-1611162617213-7d7a39e9b1d7?q=80&w=600&auto=format&fit=crop", duration: "6 ╪ú╪┤┘ç╪▒", budget: "18,000 ╪▒.╪│ / ╪┤┘ç╪▒" },
    { id: 5, slug: "fashion-brand-google-campaign", title: "╪¡┘à┘ä╪⌐ ╪Ñ╪╣┘ä╪º┘å╪º╪¬ ╪¼┘ê╪¼┘ä ┘ä╪¿╪▒╪º┘å╪» ┘ü╪º╪┤┘å", category: "digital-ads", results: "+┘ú┘ó┘á┘¬ ╪╣╪º╪ª╪» ╪╣┘ä┘ë ╪º┘ä╪Ñ┘å┘ü╪º┘é ╪º┘ä╪Ñ╪╣┘ä╪º┘å┘è╪î ┘¿ ╪ó┘ä╪º┘ü ╪¬╪¡┘ê┘è┘ä", client: "╪¿╪▒╪º┘å╪» ┘ü╪º╪┤┘å", img: "https://images.unsplash.com/photo-1441986300917-64674bd600d8?q=80&w=600&auto=format&fit=crop", duration: "4 ╪ú╪┤┘ç╪▒", budget: "80,000 ╪▒.╪│" },
    { id: 6, slug: "myhealth-influencer-campaign", title: "╪¡┘à┘ä╪⌐ ╪º┘ä┘à╪ñ╪½╪▒┘è┘å ┘ä┘à┘å╪¬╪¼ ╪╡╪¡╪¬┘è ╪º┘ä╪▒┘è╪º╪╢┘è", category: "social", results: "╪¬╪║╪╖┘è╪⌐ ┘à┘å ┘í┘Ñ ┘à╪ñ╪½╪▒╪î ┘à╪¿┘è╪╣╪º╪¬ ┘å┘ü╪»╪¬ ╪¿╪º┘ä┘â╪º┘à┘ä", client: "╪╡╪¡╪¬┘è ╪º┘ä┘à╪¡╪»┘ê╪»╪⌐", img: "https://images.unsplash.com/photo-1511512578047-dfb367046420?q=80&w=600&auto=format&fit=crop", duration: "╪┤┘ç╪▒╪º┘å", budget: "40,000 ╪▒.╪│" },
  ],
  en: [
...
const categories = {
  ar: [
    { id: "all", label: "╪º┘ä┘â┘ä" },
    { id: "digital-ads", label: "╪º┘ä╪Ñ╪╣┘ä╪º┘å╪º╪¬ ╪º┘ä╪▒┘é┘à┘è╪⌐" },
    { id: "branding", label: "╪º┘ä┘ç┘ê┘è╪⌐ ╪º┘ä╪¿╪╡╪▒┘è╪⌐" },
    { id: "video", label: "╪Ñ┘å╪¬╪º╪¼ ╪º┘ä┘ü┘è╪»┘è┘ê" },
    { id: "social", label: "╪º┘ä╪│┘ê╪┤┘è╪º┘ä ┘à┘è╪»┘è╪º" },
  ],
  en: [
    { id: "all", label: "All" },
...
export default function PortfolioPage() {
  ...
  return (
    <div>
      {/* ΓöÇΓöÇ Hero ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
      <section style={{
        background: "#0a0a0a",
        ...
        <div style={{ position: "relative" }}>
          <Reveal direction="down">
            <span style={{
              ...
              {tx(locale, { ar: "╪¿╪▒╪º┘å╪» ╪│┘è┘å┘à╪º╪ª┘è", en: "Cinema Studio" })}
            </span>
          </Reveal>
          <Reveal direction="up" delay={100}>
            <h1 style={{ fontSize: "clamp(2.4rem, 5vw, 4rem)", fontWeight: 900, color: "#fff", marginBottom: 20, lineHeight: 1.1 }}>
              {tx(locale, { ar: "┘é╪╡╪╡ ┘å╪¼╪º╪¡ ╪╡┘å╪╣┘å╪º┘ç╪º ┘ä╪╣┘à┘ä╪º╪ª┘å╪º", en: "Success Stories We Crafted" })}
            </h1>
          </Reveal>
          <Reveal direction="up" delay={200}>
            <p style={{ color: "#94a3b8", fontSize: 17.5, maxWidth: 580, margin: "0 auto", lineHeight: 1.7 }}>
              {tx(locale, {
                ar: "┘å╪│╪¬╪╣╪▒╪╢ ┘ç┘å╪º ╪¿╪╣╪╢╪º┘ï ┘à┘å ╪ú┘ü╪╢┘ä ╪ú╪╣┘à╪º┘ä┘å╪º ┘ê╪¡┘à┘ä╪º╪¬┘å╪º ╪º┘ä╪Ñ╪╣┘ä╪º┘å┘è╪⌐ ╪º┘ä┘å╪º╪¼╪¡╪⌐ ╪º┘ä╪¬┘è ╪│╪º┘ç┘à╪¬ ┘ü┘è ┘å┘à┘ê ╪º┘ä╪╣┘ä╪º┘à╪º╪¬ ╪º┘ä╪¬╪¼╪º╪▒┘è╪⌐ ┘ä╪┤╪▒┘â╪º╪ª┘å╪º.",
          ...
          <Reveal direction="up" delay={350}>
            <div style={{ display: "flex", justifyContent: "center", gap: 48, marginTop: 52, flexWrap: "wrap" }}>
              {[
                { num: "500+", label: tx(locale, { ar: "┘à╪┤╪▒┘ê╪╣ ┘à┘å╪¼╪▓", en: "Projects Done" }) },
                { num: "120+", label: tx(locale, { ar: "╪╣┘à┘è┘ä ╪▒╪º╪╢┘ì", en: "Happy Clients" }) },
                { num: "15", label: tx(locale, { ar: "╪»┘ê┘ä╪⌐", en: "Countries" }) },
              ].map((m, i) => (
      ...
      {/* ΓöÇΓöÇ Client Logos ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
      

      {/* ΓöÇΓöÇ Filter Strip ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
      ...
      {/* ΓöÇΓöÇ Portfolio Grid ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
                ...
                >
                  ...
                  <div style={{ padding: "28px 28px 32px", textAlign: "start", display: "flex", flexDirection: "column", flex: 1 }}>
                    ...
                    <div style={{ marginTop: "auto" }}>
                      ...
                      >
                        {tx(locale, { ar: "╪¬┘ü╪º╪╡┘è┘ä ╪º┘ä┘à╪┤╪▒┘ê╪╣", en: "View Project" })} ΓåÆ
                      </span>
                    </div>
                  </div>
                </Link>
      ...
      {/* ΓöÇΓöÇ CTA ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
      <section style={{
        padding: "100px 24px",
        background: "#000",
        textAlign: "center",
        ...
        <div style={{ position: "relative" }}>
          <Reveal direction="down">
            <h2 style={{ fontSize: "clamp(2rem, 4vw, 3rem)", fontWeight: 900, color: "#fff", marginBottom: 16 }}>
              {tx(locale, { ar: "┘ç┘ä ╪ú┘å╪¬ ╪¼╪º┘ç╪▓ ┘ä┘é╪╡╪⌐ ┘å╪¼╪º╪¡ ╪¼╪»┘è╪»╪⌐╪ƒ", en: "Ready for the Next Success Story?" })}
            </h2>
          </Reveal>
          <Reveal direction="up" delay={100}>
            <p style={{ color: "#94a3b8", fontSize: 17.5, marginBottom: 44, maxWidth: 480, margin: "0 auto 44px" }}>
              {tx(locale, { ar: "╪¬┘ê╪º╪╡┘ä ┘à╪╣┘å╪º ┘ê╪│┘å╪╢╪╣ ┘à╪┤╪▒┘ê╪╣┘â ┘ü┘è ┘é╪º╪ª┘à╪⌐ ╪ú╪╣┘à╪º┘ä┘å╪º ╪º┘ä┘å╪º╪¼╪¡╪⌐ ╪º┘ä┘é╪º╪»┘à╪⌐", en: "Contact us and we'll add your project to our next success stories" })}
            </p>
          </Reveal>
          <Reveal direction="up" delay={200}>
            ...
            >
              {tx(locale, { ar: "╪º╪¿╪»╪ú ┘à╪┤╪▒┘ê╪╣┘â ╪º┘ä╪ó┘å", en: "Start Your Project Now" })} ΓåÆ
            </Link>
          </Reveal>
        </div>
      </section>
