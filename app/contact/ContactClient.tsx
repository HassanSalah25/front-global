...
const whyContactUs = {
  ar: [
    { icon: "clock", title: "╪▒╪» ╪«┘ä╪º┘ä ╪│╪º╪╣╪⌐", desc: "┘ü╪▒┘è┘é┘å╪º ╪¼╪º┘ç╪▓ ┘ä┘ä╪▒╪» ╪╣┘ä┘ë ╪º╪│╪¬┘ü╪│╪º╪▒╪º╪¬┘â ╪«┘ä╪º┘ä ╪│╪º╪╣╪⌐ ┘ê╪º╪¡╪»╪⌐ ┘ü┘è ╪ú┘è╪º┘à ╪º┘ä╪╣┘à┘ä" },
    { icon: "messageSquare", title: "╪º╪│╪¬╪┤╪º╪▒╪⌐ ┘à╪¼╪º┘å┘è╪⌐", desc: "╪º╪¡╪╡┘ä ╪╣┘ä┘ë ╪º╪│╪¬╪┤╪º╪▒╪⌐ ╪¬╪│┘ê┘è┘é┘è╪⌐ ┘à╪¼╪º┘å┘è╪⌐ ┘à╪»╪¬┘ç╪º 30 ╪»┘é┘è┘é╪⌐ ┘à╪╣ ╪ú╪¡╪» ╪«╪¿╪▒╪º╪ª┘å╪º" },
    { icon: "shield", title: "╪│╪▒┘è╪⌐ ╪¬╪º┘à╪⌐", desc: "┘à╪╣┘ä┘ê┘à╪º╪¬┘â ┘ê┘à╪┤╪▒┘ê╪╣┘â ┘à╪¡┘à┘è ╪¿╪º┘ä┘â╪º┘à┘ä ┘ê┘ü┘é ╪ú╪╣┘ä┘ë ┘à╪╣╪º┘è┘è╪▒ ╪º┘ä╪«╪╡┘ê╪╡┘è╪⌐" },
    { icon: "briefcase", title: "╪«╪¿╪▒╪⌐ ╪¬╪▓┘è╪» ╪╣┘å 9 ╪│┘å┘ê╪º╪¬", desc: "┘ü╪▒┘è┘é ┘à┘å ╪º┘ä╪«╪¿╪▒╪º╪í ╪º┘ä┘à╪¬╪«╪╡╪╡┘è┘å ┘ü┘è ┘â┘ä ┘à╪¼╪º┘ä╪º╪¬ ╪º┘ä╪¬╪│┘ê┘è┘é ╪º┘ä╪▒┘é┘à┘è" },
  ],
  en: [
...
function ContactPageContent() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      alert(tx(locale, { ar: "╪¬╪╣╪░╪▒ ╪Ñ╪▒╪│╪º┘ä ╪º┘ä╪▒╪│╪º┘ä╪⌐. ╪¡╪º┘ê┘ä ┘à╪▒╪⌐ ╪ú╪«╪▒┘ë.", en: "Could not send your message. Please try again." }));
    } finally {
      setLoading(false);
    }
  }
        ...
        <Reveal direction="down">
          <div style={{
            ...
            <p style={{ color: "var(--text-muted)", fontSize: 16, lineHeight: 1.85, marginBottom: 36 }}>
              {tx(locale, {
                ar: `╪┤┘â╪▒╪º┘ï ${form.name}╪î ${t.common.successDesc}`,
            ...
            <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
              ...
              <Link href="/" style={{
                ...
                {tx(locale, { ar: "ΓåÉ ╪º┘ä╪╣┘ê╪»╪⌐ ┘ä┘ä╪▒╪ª┘è╪│┘è╪⌐", en: "ΓåÉ Back to Home" })}
              </Link>
            </div>
          </div>
        </Reveal>
  ...
  return (
    <div>
      ...
      {/* ΓöÇΓöÇ Why Contact Us ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
      ...
      {/* ΓöÇΓöÇ Contact Form + Info ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
              ...
              >
                ...
                <div>
                  <div style={{ fontWeight: 600, fontSize: 12.5, color: "var(--text-muted)", marginBottom: 4 }}>
                    {tx(locale, { ar: "╪º┘ä╪¿╪▒┘è╪» ╪º┘ä╪Ñ┘ä┘â╪¬╪▒┘ê┘å┘è", en: "Email Address" })}
                  </div>
              ...
              <Reveal key={i} delay={(i + 1) * 100} direction="right">
                ...
                >
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                    ...
                    <div>
                      <div style={{ fontWeight: 600, fontSize: 12.5, color: "var(--text-muted)", marginBottom: 4 }}>
                        {tx(locale, { ar: "╪╣┘å┘ê╪º┘å ╪º┘ä┘à┘â╪¬╪¿", en: "Office Address" })}
                      </div>
                      <div style={{ fontWeight: 700, fontSize: 14.5, color: "var(--text)", lineHeight: 1.6 }}>{office.address}</div>
                    </div>
                    <div>
                      <div style={{ fontWeight: 600, fontSize: 12.5, color: "var(--text-muted)", marginBottom: 4 }}>
                        {tx(locale, { ar: "╪▒┘é┘à ╪º┘ä┘ç╪º╪¬┘ü", en: "Phone Number" })}
                      </div>
            ...
            <Reveal direction="right" delay={400}>
              <div style={{ marginTop: 8 }}>
                <p style={{ fontWeight: 700, fontSize: 13.5, color: "var(--text-muted)", marginBottom: 16 }}>
                  {tx(locale, { ar: "╪¬╪º╪¿╪╣┘å╪º ╪╣┘ä┘ë:", en: "Follow us on:" })}
                </p>
          ...
          <Reveal direction="left" delay={150}>
            ...
            >
              ...
              <p style={{ fontSize: 12.5, color: "var(--text-muted)", marginBottom: 8 }}>
                {tx(locale, { ar: `╪º┘ä╪«╪╖┘ê╪⌐ ${step} ┘à┘å 3`, en: `Step ${step} of 3` })}
              </p>
              ...
              >
                {loading ? (
                  ...
                  `${t.common.submitBtn} ${tx(locale, { ar: "ΓåÉ", en: "ΓåÆ" })}`
                )}
              </button>
            </form>
          </Reveal>
      ...
      {/* ΓöÇΓöÇ Map / Locations Banner ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
      <section style={{
        padding: "80px 24px",
