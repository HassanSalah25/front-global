...
const staticFeaturedPost = {
  ar: {
    slug: "",
    category: "╪º╪│╪¬╪▒╪º╪¬┘è╪¼┘è╪⌐ ╪¬╪│┘ê┘è┘é┘è╪⌐",
    date: "┘è┘ê┘å┘è┘ê ┘ó┘á┘ó┘ñ",
    read_time: "┘¿ ╪»┘é╪º╪ª┘é",
    title: "┘à╪│╪¬┘é╪¿┘ä ╪º┘ä╪¬╪│┘ê┘è┘é ╪º┘ä╪▒┘é┘à┘è ┘ü┘è 2024: 10 ╪º╪¬╪¼╪º┘ç╪º╪¬ ╪│╪¬╪║┘è┘æ╪▒ ┘é┘ê╪º╪╣╪» ╪º┘ä┘ä╪╣╪¿╪⌐",
    excerpt: "╪º╪│╪¬╪╣╪▒╪º╪╢ ╪┤╪º┘à┘ä ┘ä╪ú┘ç┘à ╪º┘ä╪¬╪¡┘ê┘ä╪º╪¬ ┘ü┘è ╪╣╪º┘ä┘à ╪º┘ä╪¬╪│┘ê┘è┘é ╪º┘ä╪▒┘é┘à┘è ╪«┘ä╪º┘ä ╪º┘ä╪╣╪º┘à ╪º┘ä╪¼╪º╪▒┘è╪î ┘à┘å ╪º┘ä╪░┘â╪º╪í ╪º┘ä╪º╪╡╪╖┘å╪º╪╣┘è ╪Ñ┘ä┘ë ╪º┘ä╪¬╪│┘ê┘è┘é ╪╣╪¿╪▒ ╪º┘ä┘à╪ñ╪½╪▒┘è┘å ┘ê╪º┘ä┘à╪¡╪¬┘ê┘ë ╪º┘ä╪¬┘ü╪º╪╣┘ä┘è.",
    featured_image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=1200&auto=format&fit=crop",
    author: "╪ú╪¡┘à╪» ╪º┘ä╪▓┘ç╪▒╪º┘å┘è",
    author_image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=100&auto=format&fit=crop",
    tags: ["AI ╪¬╪│┘ê┘è┘é", "2024", "╪º╪¬╪¼╪º┘ç╪º╪¬"],
  },
  en: {
    slug: "",
...
const newsletterTopics = {
  ar: ["╪º╪│╪¬╪▒╪º╪¬┘è╪¼┘è╪º╪¬ ╪º┘ä╪¬╪│┘ê┘è┘é", "┘å╪╡╪º╪ª╪¡ ╪º┘ä╪│┘ê╪┤┘è╪º┘ä ┘à┘è╪»┘è╪º", "╪¬╪¡┘ä┘è┘ä╪º╪¬ ╪º┘ä╪╡┘å╪º╪╣╪⌐", "╪ú╪»┘ê╪º╪¬ ╪¼╪»┘è╪»╪⌐"],
...
export default function BlogPage() {
  ...
  const allTags = pickLocalized({
    ar: ["╪º┘ä┘â┘ä", "╪º┘ä╪¬╪│┘ê┘è┘é ╪º┘ä╪▒┘é┘à┘è", "╪º┘ä╪│┘ê╪┤┘è╪º┘ä ┘à┘è╪»┘è╪º", "╪º┘ä┘ç┘ê┘è╪⌐ ╪º┘ä╪¿╪╡╪▒┘è╪⌐", "SEO", "╪º┘ä╪Ñ╪╣┘ä╪º┘å╪º╪¬"],
    en: ["All", "Digital Marketing", "Social Media", "Brand Identity", "SEO", "Advertising"],
  }, locale);

  return (
    <div>
      {/* ΓöÇΓöÇ Hero ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
      <section style={{
        background: "#0a0a0a",
      ...
      {/* ΓöÇΓöÇ Featured Post ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
            ...
            >
              ...
              <div style={{ position: "relative", minHeight: 380, overflow: "hidden" }}>
                ...
                <div style={{
                  ...
                  {tx(locale, { ar: "╪º┘ä┘à┘é╪º┘ä╪⌐ ╪º┘ä┘à┘à┘è╪▓╪⌐", en: "Featured Post" })}
                </div>
              </div>
              ...
              <div style={{ padding: "44px 40px 44px 0", display: "flex", flexDirection: "column", justifyContent: "center" }} className="featured-content">
                ...
                >
                  {tx(locale, { ar: "╪º┘é╪▒╪ú ╪º┘ä┘à┘é╪º┘ä╪⌐ ╪º┘ä┘â╪º┘à┘ä╪⌐", en: "Read Full Article" })} ΓåÆ
                </Link>
              </div>
            </div>
          </Reveal>
      ...
      {/* ΓöÇΓöÇ Posts Grid ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
                  ...
                  <div style={{ padding: "28px 28px 32px", flex: 1, display: "flex", flexDirection: "column" }}>
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                      <Link href={`/blog/${post.slug ?? post.id}`} style={{
                        ...
                        {tx(locale, { ar: "╪º┘é╪▒╪ú ╪º┘ä┘à╪▓┘è╪»", en: "Read More" })} ΓåÆ
                      </Link>
                      {/* <span style={{ fontSize: 12, color: "var(--text-light)", fontWeight: 600 }}>
                        {post.read_time ?? tx(locale, { ar: `${3 + index} ╪»┘é╪º╪ª┘é ┘é╪▒╪º╪í╪⌐`, en: `${3 + index} min read` })}
                      </span> */}
                    </div>
                  </div>
                </article>
      ...
      {/* ΓöÇΓöÇ Newsletter Section ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
      <section style={{
        padding: "100px 24px",
        ...
        <div style={{ maxWidth: 700, margin: "0 auto", textAlign: "center", position: "relative" }}>
          ...
          <Reveal direction="up" delay={100}>
            <h2 style={{ fontSize: "clamp(2rem, 4vw, 2.8rem)", fontWeight: 900, color: "#fff", marginBottom: 16 }}>
              {tx(locale, { ar: "╪º╪┤╪¬╪▒┘â ┘ü┘è ┘å╪┤╪▒╪¬┘å╪º ╪º┘ä╪ú╪│╪¿┘ê╪╣┘è╪⌐", en: "Subscribe to Our Weekly Newsletter" })}
            </h2>
          </Reveal>
          <Reveal direction="up" delay={200}>
            <p style={{ color: "#94a3b8", fontSize: 16.5, marginBottom: 32, lineHeight: 1.8 }}>
              {tx(locale, {
                ar: "╪º╪¡╪╡┘ä ╪╣┘ä┘ë ╪ú┘ü╪╢┘ä ╪º┘ä┘à┘é╪º┘ä╪º╪¬ ┘ê╪º┘ä┘å╪╡╪º╪ª╪¡ ╪º┘ä╪¬╪│┘ê┘è┘é┘è╪⌐ ┘à╪¿╪º╪┤╪▒╪⌐ ┘ü┘è ╪¿╪▒┘è╪»┘â ╪º┘ä╪Ñ┘ä┘â╪¬╪▒┘ê┘å┘è ┘â┘ä ╪ú╪│╪¿┘ê╪╣",
          ...
          {subscribed ? (
            <Reveal direction="up">
              <div style={{
                ...
                <div style={{ fontSize: 52, marginBottom: 16 }}>Γ£à</div>
                <h3 style={{ color: "#34d399", fontWeight: 800, fontSize: 22, marginBottom: 8 }}>
                  {tx(locale, { ar: "╪¬┘à ╪º┘ä╪º╪┤╪¬╪▒╪º┘â ╪¿┘å╪¼╪º╪¡!", en: "Successfully Subscribed!" })}
                </h3>
                <p style={{ color: "#94a3b8", fontSize: 15 }}>
                  {tx(locale, { ar: "╪│┘è╪╡┘ä┘â ╪ú┘ê┘ä ╪╣╪»╪» ┘à┘å ╪º┘ä┘å╪┤╪▒╪⌐ ┘é╪▒┘è╪¿╪º┘ï ", en: "Your first newsletter edition is coming soon " })}
                </p>
              </div>
            </Reveal>
          ) : (
            <Reveal direction="up" delay={400}>
              <form
                onSubmit={async (e) => {
                  ...
                  try {
                    ...
                    alert(tx(locale, { ar: "╪¬╪╣╪░╪▒ ╪º┘ä╪º╪┤╪¬╪▒╪º┘â. ╪¡╪º┘ê┘ä ┘à╪▒╪⌐ ╪ú╪«╪▒┘ë.", en: "Could not subscribe. Please try again." }));
                  }
                }}
              ...
              >
                <input
                  ...
                  placeholder={tx(locale, { ar: "╪ú╪»╪«┘ä ╪¿╪▒┘è╪»┘â ╪º┘ä╪Ñ┘ä┘â╪¬╪▒┘ê┘å┘è...", en: "Enter your email..." })}
                  style={{
                ...
                >
                  {tx(locale, { ar: "╪º╪┤╪¬╪▒┘â ╪º┘ä╪ó┘å", en: "Subscribe" })}
                </button>
              </form>
              <p style={{ color: "#475569", fontSize: 12.5, marginTop: 14 }}>
                {tx(locale, { ar: "┘ä╪º ╪¬╪¡╪¬┘ê┘è ┘å╪┤╪▒╪¬┘å╪º ╪╣┘ä┘ë ╪ú┘è ╪│╪¿╪º┘à. ┘è┘à┘â┘å┘â ╪Ñ┘ä╪║╪º╪í ╪º┘ä╪º╪┤╪¬╪▒╪º┘â ┘ü┘è ╪ú┘è ┘ê┘é╪¬.", en: "No spam in our newsletter. Unsubscribe at any time." })}
              </p>
            </Reveal>
          )}
        </div>
      ...
      {/* ΓöÇΓöÇ Resources Strip ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
      {/* <section style={{ padding: "80px 24px", background: "var(--bg)" }}>
        <div style={{ maxWidth: 1000, margin: "0 auto" }}>
          <Reveal direction="down">
            <h2 style={{ fontSize: "clamp(1.8rem, 3vw, 2.4rem)", fontWeight: 900, color: "var(--text)", textAlign: "center", marginBottom: 48 }}>
              {tx(locale, { ar: " ┘à┘ê╪º╪▒╪» ┘à╪¼╪º┘å┘è╪⌐ ┘ä┘â", en: " Free Resources for You" })}
            </h2>
          </Reveal>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 24 }}>
            {pickLocalized({
              ar: [
                { icon: "", title: "╪»┘ä┘è┘ä ╪º┘ä╪¬╪│┘ê┘è┘é ╪º┘ä╪▒┘é┘à┘è 2024", type: "PDF ┘à╪¼╪º┘å┘è", color: "#6366f1" },
                { icon: "", title: "┘é╪º┘ä╪¿ ╪¬┘é╪▒┘è╪▒ ╪º┘ä╪ú╪»╪º╪í ╪º┘ä╪┤┘ç╪▒┘è", type: "Excel ┘à╪¼╪º┘å┘è", color: "#10b981" },
                { icon: "", title: "┘à╪╡╪╖┘ä╪¡╪º╪¬ ╪º┘ä╪¬╪│┘ê┘è┘é ╪º┘ä╪ú╪│╪º╪│┘è╪⌐", type: "┘é╪º┘à┘ê╪│ ┘à╪¼╪º┘å┘è", color: "#f59e0b" },
                { icon: "", title: "┘ê╪▒╪┤╪⌐ ╪╣┘à┘ä ╪º┘ä╪│┘ê╪┤┘è╪º┘ä ┘à┘è╪»┘è╪º", type: "┘ü┘è╪»┘è┘ê ┘à╪¼╪º┘å┘è", color: "#8b5cf6" },
              ],
              en: [
