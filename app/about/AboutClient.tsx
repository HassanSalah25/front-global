...
const renderValueIcon = (icon?: string) => {
  ...
  if (icon.includes("Γ£¿")) return <SparkIcon size={36} />;
  if (icon.includes("≡ƒÄÑ") || icon.toLowerCase().includes("production")) return <CameraLensIcon size={36} />;
  if (icon.includes("≡ƒÄ¼")) return <ClapperboardIcon size={36} />;
  return <FilmReelIcon size={36} />;
};

/* ΓöÇΓöÇ Timeline Section ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */
const timelineData = {
  ar: [
    { year: "2015", title: "╪¬╪ú╪│┘è╪│ ╪º┘ä╪º╪│╪¬┘ê╪»┘è┘ê", desc: "╪º┘å╪╖┘ä┘é┘å╪º ┘â╪º╪│╪¬┘ê╪»┘è┘ê ╪Ñ┘å╪¬╪º╪¼ ╪ú┘ü┘ä╪º┘à ┘ê┘ü┘è╪»┘è┘ê ┘à╪¬╪«╪╡╪╡ ╪¿╪▒╪ñ┘è╪⌐ ┘ä┘ä╪│╪▒╪» ╪º┘ä╪│┘è┘å┘à╪º╪ª┘è", icon: "film" },
    { year: "2018", title: "╪º┘ä╪¬┘ê╪│╪╣ ┘ü┘è ╪º┘ä┘à┘å╪╖┘é╪⌐", desc: "╪º┘ü╪¬╪¬╪¡┘å╪º ┘à┘â╪º╪¬╪¿ ┘ü┘è ┘à┘å╪╖┘é╪⌐ ╪º┘ä╪┤╪▒┘é ╪º┘ä╪ú┘ê╪│╪╖ ┘ê╪┤┘à╪º┘ä ╪ú┘ü╪▒┘è┘é┘è╪º ┘ä╪«╪»┘à╪⌐ ╪º┘ä╪╣┘ä╪º┘à╪º╪¬ ┘ê╪º┘ä┘à┘å╪╡╪º╪¬ ┘ê╪º┘ä┘é┘å┘ê╪º╪¬", icon: "globe" },
    { year: "2020", title: "50+ ╪╣┘à┘è┘ä", desc: "┘ê╪╡┘ä┘å╪º ╪Ñ┘ä┘ë ╪ú┘â╪½╪▒ ┘à┘å 50 ╪╣┘à┘è┘ä ╪▒╪º╪╢┘ì ┘à╪╣ ┘à╪╣╪»┘ä ┘à╪¬╪▓╪º┘è╪» ┘à┘å ╪º┘ä╪╣┘à┘ä ╪º┘ä┘à╪¬┘â╪▒╪▒", icon: "crew" },
    { year: "2022", title: "┘à╪▒┘â╪▓ ╪º┘ä╪Ñ┘å╪¬╪º╪¼ ┘ü┘è ┘à╪╡╪▒", desc: "╪ú┘å╪┤╪ú┘å╪º ╪»╪╣┘à╪º┘ï ╪Ñ┘å╪¬╪º╪¼┘è╪º┘ï ┘â╪º┘à┘ä╪º┘ï ╪╣┘ä┘ë ╪ú╪▒╪╢ ╪º┘ä┘ê╪º┘é╪╣ ┘ä┘ä╪¬╪╡┘ê┘è╪▒ ╪º┘ä╪»┘ê┘ä┘è ┘ü┘è ┘à╪╡╪▒", icon: "location" },
    { year: "2024", title: "╪╡┘è╪║ ╪ú╪╡┘ä┘è╪⌐", desc: "╪¬┘ê╪│┘æ╪╣┘å╪º ┘ü┘è ╪¬╪╖┘ê┘è╪▒ ┘é╪╡╪╡ ┘ê╪╡┘è╪║ ╪ú╪╡┘ä┘è╪⌐ ┘à╪╡┘à┘æ┘à╪⌐ ┘ä┘ä╪│┘ü╪▒ ┘ê╪º┘ä╪Ñ┘ä┘ç╪º┘à", icon: "spark" },
  ],
  en: [
...
/* ΓöÇΓöÇ Skills Bar Section ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */
const skillsData = {
  ar: [
    { label: "╪º┘ä╪Ñ╪╣┘ä╪º┘å╪º╪¬ ╪º┘ä╪¬╪¼╪º╪▒┘è╪⌐", percent: 97, color: "#6366f1" },
    { label: "╪º┘ä╪ú┘ü┘ä╪º┘à ╪º┘ä┘ê╪½╪º╪ª┘é┘è╪⌐ ┘ê╪º┘ä╪╣┘ä╪º┘à╪º╪¬ ╪º┘ä╪¬╪¼╪º╪▒┘è╪⌐", percent: 94, color: "#f59e0b" },
    { label: "╪º┘ä┘ü╪╣╪º┘ä┘è╪º╪¬ ╪º┘ä╪¡┘è╪⌐ ┘ê╪º┘ä╪¿┘ê╪»┘â╪º╪│╪¬", percent: 92, color: "#10b981" },
    { label: "╪º┘ä┘à┘ê╪┤┘å/CGI ┘ê╪º┘ä╪¬╪╡┘ê┘è╪▒", percent: 90, color: "#8b5cf6" },
    { label: "╪º┘ä╪Ñ┘å╪¬╪º╪¼ ┘à╪¬╪╣╪»╪» ╪º┘ä┘ä╪║╪º╪¬", percent: 95, color: "#ef4444" },
    { label: "╪º┘ä╪»╪╣┘à ╪º┘ä╪Ñ┘å╪¬╪º╪¼┘è ┘ü┘è ┘à╪╡╪▒", percent: 93, color: "#06b6d4" },
  ],
  en: [
...
const expertiseCategories = [
  { key: "commercials", tag: "Commercials", tagAr: "╪Ñ╪╣┘ä╪º┘å╪º╪¬", video: "/expertise/pepsico.mp4", title: "PepsiCo", poster: "" },
  { key: "documentaries", tag: "Documentaries", tagAr: "┘ê╪½╪º╪ª┘é┘è╪º╪¬", video: "/expertise/clorox.mp4", title: "Clorox", poster: "" },
  { key: "branded-films", tag: "Branded Films", tagAr: "╪ú┘ü┘ä╪º┘à ╪╣┘ä╪º┘à╪º╪¬", video: "/expertise/rose-kids.mp4", title: "Rose Kids", poster: "" },
  { key: "live-events", tag: "Live Events", tagAr: "┘ü╪╣╪º┘ä┘è╪º╪¬ ╪¡┘è╪⌐", video: "/expertise/pepsi-how-do-you-like-it.mp4", title: "Pepsi", poster: "" },
  { key: "podcasts", tag: "Podcasts", tagAr: "╪¿┘ê╪»┘â╪º╪│╪¬", video: "/expertise/best-beef.mp4", title: "Best Beef", poster: "" },
  { key: "motion-cgi", tag: "Motion/CGI", tagAr: "┘à┘ê╪┤┘å/CGI", video: "/expertise/pepsico.mp4", title: "PepsiCo", poster: "" },
];
...
export default function AboutPage() {
  ...
  return (
    <div>
      {/* ΓöÇΓöÇ Hero with particle bg ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
      <section style={{
        background: "#0a0a0a",
      ...
      {/* ΓöÇΓöÇ Story Section ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
                  ...
                  {/* <div style={{
                    ...
                    <div>
                      <div style={{ fontWeight: 800, fontSize: 13, color: "var(--text)" }}>
                        {tx(locale, { ar: "╪º╪│╪¬┘ê╪»┘è┘ê ╪Ñ┘å╪¬╪º╪¼ ┘à╪¬┘â╪º┘à┘ä", en: "Full-Service Studio" })}
                      </div>
      ...
      {/* ΓöÇΓöÇ Timeline ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
          ...
          <div style={{ textAlign: "center", marginBottom: 72 }}>
            <Reveal direction="down">
              <span style={{ display: "inline-flex", alignItems: "center", gap: 8, background: "#f1f5f9", color: "#000", fontWeight: 700, fontSize: 13, padding: "6px 20px", borderRadius: 0, marginBottom: 16 }}>
                ...
                {tx(locale, { ar: "┘à╪│┘è╪▒╪¬┘å╪º ╪╣╪¿╪▒ ╪º┘ä╪│┘å┘è┘å", en: "Our Journey" })}
              </span>
            </Reveal>
            <Reveal direction="up" delay={100}>
              <h2 style={{ fontSize: "clamp(2rem, 3.5vw, 2.8rem)", fontWeight: 900, color: "var(--text)" }}>
                {tx(locale, { ar: "┘à┘å ╪º┘ä╪¡┘ä┘à ╪Ñ┘ä┘ë ╪º┘ä┘ê╪º┘é╪╣", en: "From Dream to Reality" })}
              </h2>
            </Reveal>
          </div>
      ...
      {/* ΓöÇΓöÇ Skills/Expertise ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
      <section style={{ padding: "100px 24px", background: "var(--bg)" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
            ...
            <div>
              <Reveal direction="down">
                <span style={{ display: "inline-flex", alignItems: "center", gap: 8, background: "#fff", color: "#000", fontWeight: 700, fontSize: 13, padding: "6px 20px", borderRadius: 0, marginBottom: 20 }}>
                  ...
                  {tx(locale, { ar: "╪«╪¿╪▒╪º╪¬┘å╪º ╪º┘ä╪Ñ┘å╪¬╪º╪¼┘è╪⌐", en: "Our Production Expertise" })}
                </span>
              </Reveal>
              <Reveal direction="up" delay={100}>
                <h2 style={{ fontSize: "clamp(1.8rem, 3vw, 2.4rem)", fontWeight: 900, color: "var(--text)", marginBottom: 16, lineHeight: 1.3 }}>
                  {tx(locale, { ar: "┘å╪╡┘å╪╣ ╪¬╪¼╪º╪▒╪¿ ╪│┘è┘å┘à╪º╪ª┘è╪⌐ ┘à┘å ╪º┘ä┘ü┘â╪▒╪⌐ ╪Ñ┘ä┘ë ╪º┘ä╪Ñ╪╖╪º╪▒ ╪º┘ä╪ú╪«┘è╪▒", en: "We Craft Cinematic Experiences from Spark to Final Frame" })}
                </h2>
              </Reveal>
              <Reveal direction="up" delay={200}>
                <p style={{ color: "var(--text-muted)", fontSize: 15.5, lineHeight: 1.9, marginBottom: 36 }}>
                  {tx(locale, {
                    ar: "┘ü╪▒┘è┘é┘å╪º ┘è┘à╪¬┘ä┘â ╪º┘ä╪ú╪»┘ê╪º╪¬ ┘ê╪º┘ä╪«╪¿╪▒╪⌐ ┘ä╪Ñ┘å╪¬╪º╪¼ ┘à╪▒╪ª┘è╪º╪¬ ╪¼╪▒┘è╪ª╪⌐ ┘ä╪º ╪¬┘Å┘å╪│┘ë ╪╣╪¿╪▒ ┘â┘ä ╪º┘ä╪¬┘å╪│┘è┘é╪º╪¬ ΓÇö ╪¿╪Ñ╪¬┘é╪º┘å ┘ê┘ä┘à╪│╪⌐ ┘à┘à┘è╪▓╪⌐. ╪º╪╢╪║╪╖ ╪╣┘ä┘ë ╪ú┘è ╪¬╪«╪╡╪╡ ┘ä┘à╪┤╪º┘ç╪»╪⌐ ┘å┘à┘ê╪░╪¼ ┘à┘å ╪ú╪╣┘à╪º┘ä┘å╪º.",
                    en: "Our team possesses the tools and expertise to produce bold, unforgettable visuals across every format ΓÇö with precision and flair. Tap a specialty to preview our work.",
                  })}
                </p>
              </Reveal>
              <Reveal direction="up" delay={300}>
              ...
              >
                {activeExpertiseItem?.video ? (
                  ...
                  <div style={{ height: "100%", display: "grid", placeItems: "center", color: "rgba(255,255,255,0.55)", padding: 24, textAlign: "center" }}>
                    {tx(locale, {
                      ar: `┘ä╪º ┘è┘ê╪¼╪» ┘ü┘è╪»┘è┘ê ┘ä┘Ç ${activeExpertiseItem?.tagAr ?? "┘ç╪░╪º ╪º┘ä╪¬╪«╪╡╪╡"} ╪¿╪╣╪»`,
      ...
      {/* ΓöÇΓöÇ Mission & Vision ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
            ...
            <Reveal direction="up" delay={400}>
              <div style={{
                ...
                <h3 style={{ fontWeight: 900, fontSize: 22, color: "#fff", marginBottom: 18 }}>
                  {tx(locale, { ar: "┘é┘è┘à┘å╪º ┘ê┘ü┘ä╪│┘ü╪¬┘å╪º", en: "Our Values & Philosophy" })}
                </h3>
                <p style={{ color: "rgba(255,255,255,0.9)", fontSize: 15.5, lineHeight: 1.9 }}>
                  {tx(locale, {
                    ar: "┘å╪ñ┘à┘å ╪¿╪ú┘å ┘â┘ä ┘é╪╡╪⌐ ╪¬╪│╪¬╪¡┘é ╪ú┘å ╪¬┘Å╪▒┘ê┘ë ╪¿╪¼┘à╪º┘ä ╪│┘è┘å┘à╪º╪ª┘è ┘è╪¿┘é┘ë ┘à╪╣ ╪º┘ä╪¼┘à┘ç┘ê╪▒.",
      ...
      {/* ΓöÇΓöÇ Values ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
      ...
      {/* ΓöÇΓöÇ Team ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
